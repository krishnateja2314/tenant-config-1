...
const domainAuthConfigSchema = new mongoose.Schema(
  {
    tenantId: {
...
domainAuthConfigSchema.index({ tenantId: 1, domainId: 1 }, { unique: true });

export default mongoose.model("DomainAuthConfig", domainAuthConfigSchema);
